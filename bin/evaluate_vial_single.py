"""Simplified evaluation script for Vial dataset with tiling support."""
import contextlib
import logging
import os
import sys
...
def main(
    ...
    """Evaluate PatchCore on Vial dataset."""
    ...
    test_dataset = vial.VialDataset(
        source=data_path,
        resize=test_resize,
        imagesize=test_imagesize,
        split=vial.DatasetSplit.TEST,
    )
    ...
    if save_images:
        ...
        image_save_path = os.path.join(results_path, "segmentation_images")
