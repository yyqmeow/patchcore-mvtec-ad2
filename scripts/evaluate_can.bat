...
echo 评估完成！
echo ========================================
echo 基准结果: evaluation_results_can_baseline/results_can.csv
echo Tiling结果: evaluation_results_can_tiling_improved/results_can.csv
pause
